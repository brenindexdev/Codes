...
main:hover {
    box-shadow: #621cd4 0px 0px 10px;
...
.btn:active {
  ...
  <video id="background-video" autoplay loop muted poster="https://assets.codepen.io/6093409/river.jpg">
    <source src="img/vecteezy_purple-color-abstract-pattern-with-animation-of-morphing_27989783" type="video/mov">
  </video>

  <div class="container d-flex justify-content-center align-items-center vh-100">
    <main class="form-signin bg-white rounded shadow">
        <div>
            <div><a href=".."><img class="m-1" src="../img/arrow-left-circle.svg">Voltar</a></div>
        </div>

        <form class="text-center mx-auto p-4" method="POST" action="login_cadastro.php">
