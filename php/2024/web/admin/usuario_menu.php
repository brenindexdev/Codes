<?php 
    ...
    } else 
    {
        ...
        $q = "SELECT COUNT(id) FROM usuario WHERE nome like 
            '%$where%'";
    ...
    $q = "SELECT id, nome, sobrenome, email, data_inclusao
            FROM usuario
    ...
    if (mysqli_num_rows($r) > 0) {
            ...
            <table class='table table-striped'>
                <thead>
                    <tr>
                        ...
                        <th><a href='usuario_menu.php?ordem=n'>Nome</a></th>
                        <th><a href='usuario_menu.php?ordem=e'>E-mail</a></th>
                        <th><a href='usuario_menu.php?ordem=d'>Data Inclusão</a></th>
                        <th>Ações</th>
                    </tr>
                </thead>
                <tbody>";
        while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC))
        {
            $saida .= "<tr>
                        ...
                        "<td>
                            <a href='usuario_alt.php?id=".$row['id']."' 
                                class='btn btn-sm btn-warning'>Editar</a>
                            <a href='usuario_exc.php?id=".$row['id']."' 
    ...
    if ($pagina > 1)
    {
        ...
        if ($pagina_correta != 1)
        {
            ...
            <a class="page-link" href="usuario_menu.php?s=' .
        ...
        <div class="input-group">
            ...
            <div class="input-group-append">
                <a class="btn btn-primary" 
                    href="#"
                    onclick="this.href='usuario_menu.php?q='+
